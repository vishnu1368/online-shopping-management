    function validate(){
       ...
       // window.alert(name + " " + password +  " " + country + " "+ state + " "  + street + " " + city + " " + mail + " " +phone)
        var x = filled(name, password, mail, phone, street, city, state, country)
        var y  = true, z = true
        if(password != "")
    ...
    function add_user(detail, callback){
        ...
        var val = "'" + detail.name + "', '" + detail.password + "','" + detail.mail + "','" + detail.phone + "',null,'" + detail.street +"','"+detail.city + "','" + detail.state +"','" + detail.country+ "')"   
